...
import { FiUser, FiMail, FiLock, FiBookOpen, FiMapPin, FiAward } from 'react-icons/fi';
    ...
    <div className="flex items-center justify-center min-h-screen bg-slate-50 px-4 py-8">
      <div className="w-full max-w-xl bg-white border border-slate-100 rounded-3xl p-8 shadow-xl shadow-slate-100/50">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-indigo-600 text-white font-bold text-2xl shadow-md shadow-indigo-600/20 mb-4">
            E
          </div>
          <h2 className="text-2xl font-bold text-slate-800">Establish Your Institute</h2>
          <p className="text-sm text-slate-400 mt-1">Register a school portal & setup Admin credentials</p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 bg-slate-50 border ${
                      errors.instituteName ? 'border-red-300 focus:ring-red-100' : 'border-slate-200 focus:ring-indigo-100'
                    } rounded-xl text-sm focus:outline-none focus:ring-4 transition duration-150`}
                    {...register('instituteName', { required: 'Institute name is required' })}
                  />
                </div>
                {errors.instituteName && (
                  <span className="text-xs text-red-500 mt-1 block">{errors.instituteName.message}</span>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="STAN"
                    className={`w-full pl-10 pr-4 py-2.5 bg-slate-50 border ${
                      errors.instituteCode ? 'border-red-300 focus:ring-red-100' : 'border-slate-200 focus:ring-indigo-100'
                    } rounded-xl text-sm focus:outline-none focus:ring-4 transition duration-150`}
                ...
                {errors.instituteCode && (
                  <span className="text-xs text-red-500 mt-1 block">{errors.instituteCode.message}</span>
                )}
              </div>
